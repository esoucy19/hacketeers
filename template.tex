...
\name{\VAR{first_name} LASTNAME} % Your name
\address{STREETNUMBER STREETNAME \\ CITY , COUNTRY POSTALCODE} % Your address
%\address{123 Pleasant Lane \\ City, State 12345} % Your secondary addess (optional)
\address{ PHONENUMBER \\ EMAIL} % Your phone number and email
